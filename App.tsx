...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full relative bg-[#005060] selection:bg-[#e2b36e] selection:text-[#005060] flex flex-col">
      ...
      <header className="flex-none h-24 flex items-center justify-center mb-10 z-20 select-none">
      ...
      <div className="flex-1 w-full max-w-[1920px] mx-auto px-6 md:px-12 lg:px-20 xl:px-28 flex flex-col lg:flex-row gap-16 relative z-10 h-auto">
          ...
          {/* LEFT TOOL COLUMN: Reduced min-h to 70vh */}
          <GlassCard className="w-full lg:w-[360px] xl:w-[420px] shrink-0 flex-none flex flex-col p-5 lg:p-6 min-h-[70vh]">
          ...
          <div className="w-full lg:flex-1 h-auto flex flex-col gap-6 min-w-0">
              {/* RESULT AREA: Reduced min-h to 50vh */}
              <GlassCard className="flex-1 w-full flex flex-col relative overflow-hidden min-h-[50vh] shrink-0">
