                ...
                <div className="flex-1 flex flex-col gap-2 mb-6 min-h-[150px]">
                  <div className="flex justify-between items-center">
                    ...
                    {(inputImages.length > 0 || referenceImages.length > 0) && (
                        <button onClick={handleAutoPrompt} disabled={isAutoPrompting} className={`flex items-center gap-1.5 px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider transition-all shadow-lg ${isAutoPrompting ? 'bg-[#09232b] text-white cursor-wait' : 'bg-[#103742]/60 text-[#e2b36e] border border-[#e2b36e]/30 hover:bg-[#e2b36e]/20'}`}><Sparkles size={10} className={isAutoPrompting ? "animate-spin" : ""} />{isAutoPrompting ? 'Reading...' : 'Auto Prompt'}</button>
                    )}
                  </div>
